 ...
 */
public class DefRock extends StaticEntity {
    ...
    public DefRock(Handler handler, float x, float y) {
    ...
    public void die() {
        ...
        handler.getWorld().getItemManager().addItem(Item.LessDame.createNew((int)x + bounds.x,(int)y + bounds.y,1));
