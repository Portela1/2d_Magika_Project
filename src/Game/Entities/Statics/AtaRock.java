 ...
 */
public class AtaRock extends StaticEntity {
    ...
    public AtaRock(Handler handler, float x, float y) {
    ...
    public void die() {
        ...
        handler.getWorld().getItemManager().addItem(Item.MoreAta.createNew((int)x + bounds.x,(int)y + bounds.y,1));
